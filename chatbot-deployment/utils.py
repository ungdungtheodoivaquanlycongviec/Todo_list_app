...
def replace_placeholders(template: str, context: Optional[Dict[str, Any]]) -> str:
  ...
  Nếu thiếu context, trả về nguyên template.
  """
  if not context:
    return template
  ...
  mapping = {
    ...
    "current_date": date.get("current_date") or "",
    "current_date_vn": date.get("current_date_vn") or "",
    # Các placeholder mở rộng, chưa có data thì để trống
    "special_day": "",
    "location": "",
    "weather_condition": "",
    "temperature": "",
