...
import { 
  X, Calendar, Clock, User, Flag, Lock, MapPin, 
  Paperclip, PlayCircle, Timer, MessageSquare,
  Edit2, Save, Trash2, Send
} from 'lucide-react';
...
export default function TaskDetailModal({
  ...
  // Helper function để lấy tên user từ comment
  ...
  // Helper function để lấy avatar hoặc chữ cái đầu
                  ...
                  <div className="flex-1">
                    <div className="relative">
                      <textarea
                        ...
                        rows={3}
                        className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 pr-12"
                      />
                      <button
                        onClick={handleAddComment}
                        disabled={!comment.trim()}
                        className="absolute bottom-3 right-3 p-1 text-blue-500 hover:text-blue-600 disabled:opacity-50"
                      >
