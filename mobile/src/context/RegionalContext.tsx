...
// Các Context dependencies giữ nguyên
import { useAuth } from './AuthContext';
import { useLanguage } from './LanguageContext';
import { RegionalPreferences } from '../types/auth.types';
import { monthNamesShort } from '../i18n/DateLocales'; // Giả định file này tồn tại
...
  // --- HÀM XỬ LÝ TIMEZONE (Tái sử dụng nguyên vẹn) ---
...
  // --- HÀM FORMATTING (Tái sử dụng nguyên vẹn) ---
...
    
    // Cần đảm bảo rằng các nhãn này (labels) đã được đồng bộ với LanguageContext hoặc hardcoded như sau:
    const labels = {
